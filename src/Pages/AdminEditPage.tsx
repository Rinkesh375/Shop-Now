...
import { editAdminProduct,getSingleEditProduct } from '../api/api';
        ...
        <>
            ...
            <Box w="35%" m="3rem auto" p="2rem" boxShadow='rgba(17, 17, 26, 0.1) 0px 1px 0px, rgba(17, 17, 26, 0.1) 0px 8px 24px, rgba(17, 17, 26, 0.1) 0px 16px 48px;'>
                ...
                <form onSubmit={formHandler}>
                    <Stack spacing="2rem">
                        <FormControl><Input type='text' required border="2px solid #282828" placeholder="Enter the product title (name):-" value={title} onChange={(e) => setNewProduct({ ...newProduct, title: e.target.value })} /></FormControl>
                        <FormControl><Input type='text' required border="2px solid #282828" placeholder='Enter the product image:-' value={image} onChange={(e) => setNewProduct({ ...newProduct, image: e.target.value })} /></FormControl>
                        ...
                        <FormControl><Input type='text' required border="2px solid #282828" placeholder="Enter the product price after discount:-" value={discountprice == 0?"":discountprice} onChange={(e) => setNewProduct({ ...newProduct, discountprice: +e.target.value })} /></FormControl>
